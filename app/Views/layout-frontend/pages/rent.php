				...
				<?php foreach ($rents as $row) : ?>
					<div class="item px-2">
						<div class="fh5co_hover_news_img">
							<div class=""><img style="height: 240px;" class="img-fluid" src="<?= base_url('uploads/rents/' . $row->rent_foto) ?>" alt="No Image" /></div>
							<div>
								<a href="single.html" class="d-block fh5co_small_post_heading"><span class=""><?= $row->rent_nama_mobil ?> | Kapasitas : <?= $row->rent_max_penumpang ?></span></a>
								<div class="c_g"><i class="fa fa-money"></i> <?= rupiah($row->rent_harga) ?></div>
							</div>
						</div>
					</div>
				<?php endforeach; ?>
					...
					<div class="col-md-4" style="margin-bottom: 15px;">
						<div class="issuse-wrap2 clearfix">
							<center>
								...
								<p>
									<a target="_blank" href="<?= base_url('detail-rent/' . $row->rent_id) ?>" class="mt-2 btn btn-primary btn-sm">Detail</a>
								</p>
							</center>
						</div>
					</div>
