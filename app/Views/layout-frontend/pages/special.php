					...
					<div class="col-md-4" style="margin-bottom: 15px;">
						<div class="issuse-wrap2 clearfix">
							<center>
								...
								<small><?= $row->special_kode ?> | Category: <?= $row->special_kategori ?></small>
								<p>
									<a target="_blank" href="<?= base_url('detail-special/' . $row->special_id) ?>" class="mt-2 btn btn-primary btn-sm">Detail</a>
								</p>
							</center>
						</div>
					</div>
