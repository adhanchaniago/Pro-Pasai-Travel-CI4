					...
					<div class="row pb-4">
						<div class="col-md-12 animate-box">
							<div class="fh5co_hover_news_img">
								<div class=""><img style="height: 280; width: 100%;" src="<?= base_url('uploads/regulars/' . $regulars->relugar_foto) ?>" alt="" /></div>
								<div></div>
							</div>
							<div class="fh5co_magna py-2"><?= $regulars->relugar_nama_paket ?></div>
							<div class="fh5co_mini_time py-3"> Route: <?= $regulars->relugar_rute ?></div>
								...
								<p>
									<div class="row">
										<div class="col-md-6 col-xs-12">
											Include <br>
											<?= $regulars->relugar_include ?></div>
										<div class="col-md-6 col-xs-12">
											Exclude <br>
											<?= $regulars->relugar_exclude ?></div>
									</div>
								</p>
								<h4>Price</h4>
								<p>
									<?= $regulars->relugar_harga ?>
								</p>
								<h4>Trips</h4>
								<p>
