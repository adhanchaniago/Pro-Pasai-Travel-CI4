...
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=devle-width, initial-scale=1, shrink-to-fit=no">
    <title><?= $title ?></title>
    <link rel="icon" href="<?= base_url() ?>/logo_baru.png">
    <link href="<?= base_url() ?>/assets-frontend/css/media_query.css" rel="stylesheet" type="text/css" />
    ...
    <link href="<?= base_url() ?>/assets-frontend/css/owl.theme.default.css" rel="stylesheet" type="text/css" />
    <!-- Bootstrap CSS -->
