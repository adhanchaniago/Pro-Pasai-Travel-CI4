                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>BRI</label>
                                        <input value="<?= $contacts->contact_rek_bri ?>" type="text" class="form-control" name="bri" required>
                                    </div>
                                    <div class="form-group">
                                        <label>BNI</label>
                                        <input value="<?= $contacts->contact_rek_bni ?>" type="text" class="form-control" name="bni" required>
                                    </div>
                                    <div class="form-group">
                                        <label>BCA</label>
                                        <input value="<?= $contacts->contact_rek_bca ?>" type="text" class="form-control" name="bca" required>
                                    </div>
                                </div>
                            </div>
                        </div>
